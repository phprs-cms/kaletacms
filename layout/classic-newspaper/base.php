...
<link rel="stylesheet" href="<?= e($url('layout/classic-newspaper/style.css')) ?>?v=<?= e(MIROCMS_VERSION) ?>">
<?= $hlava ?>
</head>
<body>
...
<header class="hlavicka">
	<div class="obal">
		<div class="hlavicka-lista">
			...
			<span class="sluzby"><a href="<?= e($url('hledani')) ?>"><?= e(t('Hledat')) ?></a><a href="<?= e($url('rss.xml')) ?>">RSS</a><?= $ucet_html ?? '' ?><?= $jazyky_html ?? '' ?></span>
		</div>
...
<?php endforeach ?>
		<span>&copy; <?= date('Y') ?> &middot; <a href="<?= e($url('rss.xml')) ?>">RSS</a> &middot; <?= e(t('běží na MiroCMS')) ?></span>
	</div>
</footer>
<?= $pata ?>
</body>
