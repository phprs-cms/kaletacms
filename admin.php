<?php
/**
 * MiroCMS - administrace.
 * Adresy mají stejný tvar jako v MiroCMS 2: admin.php?modul=clanky&akce=edit&id=5
 */
...
$odpoved = (new MiroCMS\Admin\Kernel($app))->handle();
...
(new MiroCMS\Core\Response($odpoved->body, $odpoved->status, $odpoved->headers + [
