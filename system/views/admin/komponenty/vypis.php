...
<?php if ($komponenty === []): ?>
<?= $app->view->render('admin/prazdno', ['ikona' => 'komponenta', 'nadpis' => t('Zatím žádné komponenty.'), 'text' => t('Komponenta je blok, který používáte na víc místech – karta služby, kontaktní pruh, výzva. Ve staviteli vyberte prvek a zvolte „Uložit jako komponentu“; když ji pak upravíte, změní se všude najednou.'), 'akce' => [$modul->url('novy'), t('Založit komponentu')]]) ?>
<?php else: ?>
<div class="tab-obal">
<table class="vypis">
