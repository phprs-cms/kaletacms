...
<div class="radek"><label for="na_adresu"><?= e(t('Přesměrovat na')) ?></label><div><input class="textpole siroke" type="text" id="na_adresu" name="na_adresu" maxlength="255" required placeholder="<?= e(t('/nova-adresa nebo https://…')) ?>"></div></div>
