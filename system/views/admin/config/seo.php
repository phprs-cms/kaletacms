...
?>
<p class="napoveda"><?= e(t('Co systém generuje:')) ?> <a href="<?= e($adresaWebu) ?>robots.txt" target="_blank" rel="noopener"><?= e(t('robots.txt')) ?></a> · <a href="<?= e($adresaWebu) ?>sitemap.xml" target="_blank" rel="noopener"><?= e(t('sitemap.xml')) ?></a> · <a href="<?= e($adresaWebu) ?>llms.txt" target="_blank" rel="noopener"><?= e(t('llms.txt')) ?></a> · <a href="<?= e($adresaWebu) ?>rss.xml" target="_blank" rel="noopener"><?= e(t('rss.xml')) ?></a> · <a href="<?= e($adresaWebu) ?>feed.json" target="_blank" rel="noopener"><?= e(t('feed.json')) ?></a></p>
</details>
